...
if(isset($_POST["all_send"])){
    ...
    ?>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item orkos studio wow fadeInUpBig" data-wow-delay="300ms">
                    ...
                    <div class="gallery-content">
                       <h4><font color=black><?php echo "$nom_unit"?></font></h4>
                    </div>
                </div>
    <?php
    }
    ...
    <div class="col-12 col-sm-6 col-lg-3 single_gallery_item orkos studio wow fadeInUpBig" data-wow-delay="300ms">
                    ...
                    <!-- Gallery Content -->
                    <div class="gallery-content">
                        <h4><font color=black><?php echo "$nom_ve"?></font></h4>
                    </div>
                </div>
    <?php
    }
    ...
    <div class="col-12 col-sm-6 col-lg-3 single_gallery_item orkos studio wow fadeInUpBig" data-wow-delay="300ms">
                    ...
                    <!-- Gallery Content -->
                    <div class="gallery-content">
                        <h4><font color=black><?php echo "$nom_an"?></font></h4>
                    </div>
                </div>
    <?php
    }
...
<div class="col-12 col-sm-6 col-lg-3 single_gallery_item orkos studio wow fadeInUpBig" data-wow-delay="300ms">
                ...
                <!-- Gallery Content -->
                <div class="gallery-content">
                    <h4><font color=black><?php echo "$nom_an"?></font>s</h4>
                </div>
            </div>
<?php
}
